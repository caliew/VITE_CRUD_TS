  ...
  useEffect(() => {
    const option = {
      ...
      series: [
        // LEFT
        { 
          name: 'Left Radial 1', type: 'gauge', min: -200, max: 250,
          startAngle: -30, endAngle: -315, splitNumber: 9, radius: '35%', center: ['21%', '55%'],
          ...
          pointer: { show: false },
          detail: { show: false },
          title: { fontSize: 16, fontWeight: 5, fontFamily: 'Tahoma', color: '#fff', offsetCenter: [0, '-40%'] },
          progress: { show: true, width: 3, itemStyle: { color: 'blue' } },
          data: [ { value: 50, name: 'km/h' } ]
        },
        { 
          name: 'Left Radial 2', type: 'gauge', min: 0, max: 250,
          startAngle: -140, endAngle: -305, splitNumber: 5, radius: '35%', center: ['21%', '55%'],
          axisLine: { lineStyle: { color: [[1, '#AE96A6']] } },
          splitLine: { distance: -7, length: 12, lineStyle: { color: '#fff', width: 4 } },
          axisTick: { distance: -8, length: 8, lineStyle: { color: '#fff', width: 2 } },
          axisLabel: { distance: 16, fontSize: 17, fontFamily: 'Tahoma', color: 'white' },
          anchor: {},
          pointer: {
            ...
            width: 5, length: '40%', offsetCenter: [0, '-58%'],
            itemStyle: { color: '#f00', shadowColor: 'rgba(255, 0, 0)', shadowBlur: 5, shadowOffsetY: 2 }
          },
          title: { color: '#fff', fontSize: 18, fontWeight: 100, fontFamily: 'Roboto', offsetCenter: [0, 20] },
          detail: {  show: false },
          data: [ { value: 125, name: 'LOCATION：\n\n中科路' } ]
        },
        // MIDDLE
        {
          name: 'Middle Radial 1', type: 'gauge', min: 0, max: 8, z: 10,
          startAngle: 210, endAngle: -30, splitNumber: 8, radius: '50%', center: ['50%', '50%'],
          axisLine: { show: true, lineStyle: { width: 0, color: [ [0.825, '#fff'], [1, '#f00'] ] } },
          splitLine: { distance: 20, length: 15, lineStyle: { color: 'auto', width: 4, shadowColor: 'rgba(255, 255, 255, 0.5)', shadowBlur: 15, shadowOffsetY: -10 }},
          axisTick: { distance: 20, length: 8, lineStyle: { color: 'auto', width: 2, shadowColor: 'rgba(255, 255, 255)', shadowBlur: 10, shadowOffsetY: -10 } },
          axisLabel: { distance: 14, fontSize: 30, fontFamily: 'Tahoma', color: 'cyan' },
          anchor: {},
          pointer: {
            icon: 'path://M-36.5,23.9L-41,4.4c-0.1-0.4-0.4-0.7-0.7-0.7c-0.5-0.1-1.1,0.2-1.2,0.7l-4.5,19.5c0,0.1,0,0.1,0,0.2v92.3c0,0.6,0.4,1,1,1h9c0.6,0,1-0.4,1-1V24.1C-36.5,24-36.5,23.9-36.5,23.9z M-39.5,114.6h-5v-85h5V114.6z',
            width: 10, offsetCenter: [0, '-10%'], length: '75%',
            itemStyle: { color: '#f00', shadowColor: 'rgba(255, 0, 0)', shadowBlur: 5, shadowOffsetY: 3 }
          },
          title: { color: '#fff', fontSize: 18, fontWeight: 80, fontFamily: 'Tahoma', offsetCenter: [0, '0%'] },
          data: [ { value: 4.6, name: '1/min x 1000' } ],
          detail: { show: false }
        },
        {
          name: 'Middle Radial 2', type: 'gauge', min: 0, max: 8, z: 10, splitNumber: 8, radius: '50%',
          axisLine: { lineStyle: { width: 14, color: [[1, '#000']] } },
          splitLine: { show: false },
          axisTick: { show: false },
          axisLabel: { show: false },
          anchor: {},
          pointer: { show: false },
          title: { color: 'cyan', fontSize: 28, fontFamily: 'Roboto', fontWeight: 80, offsetCenter: [0, 120] },
          detail: { 
            offsetCenter: ['5%', '40%'], 
            formatter: '{a|{value}}{b|km/h}', 
            rich: { 
              a: { fontSize: 40, fontWeight: 80, fontFamily: 'Roboto', color: '#fff', align: 'center', padding: [0, 5, 0, 0] },
              b: { fontSize: 15, fontWeight: 80, fontFamily: 'Roboto', color: '#fff', padding: [0, 0, 30, 0] }
            }
          },
          // value is speed
        ...
        // RIGHT
        {
          name: 'Right Radial 1', type: 'gauge', min: 0, max: 8,
          startAngle: 135, endAngle: -150, splitNumber: 8, radius: '35%', center: ['79%', '55%'],
          axisLine: { lineStyle: { color: [[1, '#AE96A6']] } },
          splitLine: { show: false },
          axisTick: { show: false },
          axisLabel: { show: false },
          ...
          detail: { 
            offsetCenter: ['-25%', 0],
            formatter: [ 
              '{a|                   00:00}','{a|行驶时间       0:00}{b| h}','{a|行驶距离        0.0}{b| km}',
              '{a|平均耗能        ---}{b| 1/100km}','{a|平均速度        ---}{b| km/h}' ].join('\n'),
            rich: {
              a: { fontSize: 14, fontFamily: 'Tahoma', lineHeight: 22, color: '#fff', align: 'left' },
              b: { fontSize: 14, fontFamily: 'Tahoma', lineHeight: 12, color: 'white', align: 'left' } }
          },
          progress: { show: true, width: 3, itemStyle: { color: '#fff' } },
          data: [ { value: 250, name: '' }]
        },
        {
          name: 'Right Radial 2', type: 'gauge', min: 0, max: 1,
          startAngle: 125, endAngle: 55, splitNumber: 2, radius: '34%', center: ['79%', '55.3%'],
          axisLine: { lineStyle: { width: 9, color: [ [0.15, '#f00'], [1, 'rgba(255, 0, 0, 0)'] ] } },
          splitLine: { distance: -14, length: 16, lineStyle: { color: '#fff', width: 4 } },
          axisTick: { distance: -14, length: 10, lineStyle: { color: '#fff', width: 2 } },
          axisLabel: { distance: 12, fontSize: 18, fontWeight: 80, fontFamily: 'Tahoma', color: '#fff',
            formatter: function (value) {
              if (value === 0.5) { return '2/4'; }
              if (value === 1) { return '4/4'; }
              return value + '';
            }
          },
          progress: { show: true, width: 5, itemStyle: { color: 'orange' } },
          anchor: {
            show: true, itemStyle: {}, offsetCenter: ['-22%', '-57%'], size: 24,
          ...
          detail: {
            ...
            rich: {
              a: { fontSize: 15, fontWeight: 80, fontFamily: 'Tahoma', color: '#fff' },
        ...
        {
          name: 'Right Radial 3', type: 'gauge', min: -120, max: -60,
          startAngle: 230, endAngle: 310, clockwise: false, splitNumber: 2, radius: '35%', center: ['79%', '55%'],
          axisLine: { lineStyle: { color: [ [1, '#AE96A6'], [1.1, '#f00'] ] } },
          splitLine: { distance: -8, length: 12, lineStyle: { color: '#fff', width: 4 } },
          axisTick: { splitNumber: 3, length: 8, distance: -8, lineStyle: { color: '#fff', width: 2 } },
          axisLabel: { 
            distance: 14, fontSize: 18, fontWeight: 80, fontFamily: 'Tahoma', color: '#fff',
            formatter: function (value) { return -value + ''; }
          },
          anchor: {
            show: true, itemStyle: {}, offsetCenter: [0, '55%'],size: 20,
          ...
          pointer: {
            ...
            width: 15, length: '4', offsetCenter: [0, '-90%'], itemStyle: { color: '#f00' }
          },
          title: {},
          detail: { show: false },
          data: [ { value: 90, name: '' } ]
