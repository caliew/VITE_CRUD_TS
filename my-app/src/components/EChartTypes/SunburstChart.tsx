...
const dataMock = [
  { name: 'ZONE 1',
    children: [
      { name: 'MONT KIARA', 
        children: [  { name: 'PLAZA MONT KIARA',  children: [{ name: 'FLAG', value: 1 }] },
                     { name: 'KAIRAMS DANAI',  children: [{ name: 'FLAG', value: 1 }] },
                     { name: 'KAMPUNG SEGAMBUT',  children: [{ name: 'FLAG', value: 1, itemStyle: ColorCode[4] }] } ] },
      { name: 'MUTIARA DAMANSARA', 
        children: [  { name: 'HAUNTU MALAYSIA', children: [{ name: 'FLAG', value: 1 }] }, 
                     { name: 'IPC SHOPPING CENTER', children: [{ name: 'FLAG', value: 1 }] },
                     { name: 'MUTIARA HOMES', children: [{ name: 'FLAG', value: 1 }] } ] },
      { name: 'BUKIT DAMANSARA', 
        children: [  { name: 'SRI BERINGIN', children: [{ name: 'FLAG', value: 1 }] }, 
                     { name: 'DESA DAMANSARA', children: [{ name: 'FLAG', value: 1 }] }, 
                     { name: 'ISTANA NEGARA', children: [{ name: 'FLAG', value: 1 }] } ] },
      { name: 'TAMAN DUTA', 
        children: [  { name: 'BUKIT TUNKU', children: [{ name: 'FLAG', value: 1 }]}, 
  ...
  { name: 'ZONE 2', 
    children: [ 
      { name: 'KAMPUNG BARU',  
        children: [ { name: 'PWTC', children: [{ name: 'FLAG', value: 1 }]}, 
      ...
      { name: 'TITIWANGSA', 
        children: [ { name: 'ISTANA BUDAYA', children: [{ name: 'FLAG', value: 1 }] },
                    { name: 'NATIONAL ART GALLERY', children: [{ name: 'FLAG', value: 1 }]}, 
  ...
  { name: 'ZONE 3',
    children : [
      { name: 'TAMAN KERAMAT', 
        children : [{ name: 'JLN ENGGANG', children: [{ name: 'FLAG', value: 1 }]},
                    { name: 'TAMAN DESA KERAMAT', children: [{ name: 'FLAG', value: 1 }]},
  ...
  { name : 'ZONE 4',
    children : [
      { name: 'AMPANG JAYA', 
        children: [{ name: 'AMPANG POINT', children: [{ name: 'FLAG', value: 1 }]}, 
      ...
      { name: 'CHERAS', 
        children:[{ name: 'TAMAN MIDAH', children: [{ name: 'FLAG', value: 1 }]}, 
                  { name: 'BANDAR TUN RAZAK', children: [{ name: 'FLAG', value: 1 }]}, 
                  { name: 'BANDAR SRI PERMAISURI', children: [{ name: 'FLAG', value: 1 }]}, 
  ...
  { name : 'ZONE 6',
    children : [
      { name: 'TAMAN OUG', 
        children :[{ name: 'TAMAN YARL', children: [{ name: 'FLAG', value: 1 }]},
      ...
      { name: 'BUKIT JALIL', 
        children :[{ name: 'SRI PETALING', children: [{ name: 'FLAG', value: 1 }]},
...
const SunburstChart : React.FC<SunburstProp> = ({className,title,data,onEventCallback}) => {
  ...
  useEffect(() => {
    ...
    const option = {
      textStyle:{fontFamily:'Roboto',fontSize:10,fontWeight:100,color:'#FFFFFF'},
      series: [
        {
          radius: ['15%', '99%'],
          type: 'sunburst',
          ...
          label: { rotate:0, fontSize: 12, fontFamily: 'Roboto', fontWeight: 300,color:'#000000' },
          levels: [
            { },
          ]
        }
