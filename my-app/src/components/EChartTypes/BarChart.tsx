...
const BarChart : React.FC<BarChartProp> = ({className,title,subtitle,seriesLabels,legendsLabels}) => {
  ...
  useEffect(() => {
    const option = {
      ...
      legend: {
        ...
        textStyle: { fontFamily: 'Roboto', fontSize: 16, fontWeight: 1, color: 'white', padding: [0, 0, 0, 0]} },
      toolbox: {
        show: true,
        feature: {
      ...
      yAxis: [ { type: 'value' } ],
      series: [
        { name: seriesLabels[0], type: 'bar',
          data: [ 2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3 ],
          markPoint: { data: [ { type: 'max', name: 'Max' }, { type: 'min', name: 'Min' } ] },
          markLine: { data: [{ type: 'average', name: 'Avg' }] }
        },
        { name: seriesLabels[1], type: 'bar',
