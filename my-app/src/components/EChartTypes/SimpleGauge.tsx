      ...
      series: [
        {
          ...
          startAngle: 200, endAngle: -20, center: ["50%", "50%"], 
          ...
          axisLabel: { distance: 5, color: "#999", fontSize: 14, fontFamily: "Tahoma",  
                       formatter: function (value) { return value.toFixed(0); } },
          anchor: { },
          pointer: { show: false },
          title: { color: 'cyan', fontSize: 22, fontFamily: 'Roboto', fontWeight: 80, offsetCenter: [0, 60] },
          detail: {
            offsetCenter: ['0%', '20%'], fontSize: 8,
            formatter: `{a|{value}}{b|${unit}}`, 
            rich: { 
              a: { fontSize: 22, fontFamily: 'Roboto', fontWeight: 80, color: '#fff', align: 'center', padding: [0, 5, 0, 0] },
              b: { fontSize: 13, fontFamily: 'Roboto', fontWeight: 80, color: '#fff', padding: [0, 0, 10, 0] }
            }
          },
