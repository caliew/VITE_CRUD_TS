const NavHeaderClass =
  "mx-auto flex justify-between items-center font-Roboto font-extralight text-2xl";

const RoutesClasses = ""; // ml-64 p-4

const SPKAPageClasses =
  "z-0 w-screen flex flex-col flex-wrap w-full items-center justify-center shadow-orange-500/50";

const PageClasses =
  "w-full flex p-2 font-Roboto flex flex-col flex-wrap items-center justify-center shadow-cyan-500/50 gap-5";

const PageContainClasses =
...
const VisitorRouteClasses = "w-full h-full p-2 bg-n-8 overflow-hidden";
...
function CardClasses(px?: string, white?: boolean, className?: string): string {
  return `relative flex flex-col items-center justify-center h-11 transition-colors 
            ...
            ${px || "px-3"} ${white ? "text-n-8" : "text-n-1"} ${
    className || ""
  } `;
}
const CardIconClasses = "size-8 text-white stroke-[0.75] absoluteStrokeWidth";
const CardHeaderClasses =
  "flex justify-center items-center font-Roboto text-2xl text-center font-extralight border-y-2 border-color-0";
const CardTitleClasses =
  "flex flex-col flex-wrap py-2 font-Roboto text-2xl font-light justify-center items-center";
const CardTitleGroupClasses =
  "flex flex-wrap justify-center item-center font-Roboto text-2xl text-center py-1 border-y-2";
const CardTitleNameClasses =
  "flex flex-wrap justify-center item-center font-Roboto font-extralight text-xl text-center pt-2";
// "flex font-Roboto font-extralight text-lg text-justify inline-block truncate text-overflow-ellipsis"
const CardSensorIDClasses =
  "m-2 font-Roboto text-2xl font-extralight border-y-2 border-color-0";
